...
function getUsername(senderId) {
  if (senderId && currentUser === null) {
    ...
    sendTextMessage(senderId, "Hola " + currentUser.firstName + "!"+ "Soy Superbot y te voy ayudar encontrando gif animados de cualquiere tema que necesites, ingresa la palabra giphy a continuación");
  }
}
